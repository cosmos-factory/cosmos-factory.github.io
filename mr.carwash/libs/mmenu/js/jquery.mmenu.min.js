    ...
    if (!(e[n] && e[n].version > s)) {
        e[n] = function (e, t, n) {
            ...
            init: function (e) {
                ...
                this.$menu.find("." + i.listview).children("." + i.selected).removeClass(i.selected), e.addClass(i.selected), this.trigger("setSelected", e)
            }, bind: function (e, t) {
                e = "init" == e ? "initPanels" : e, this.cbck[e] = this.cbck[e] || [], this.cbck[e].push(t)
            }, trigger: function () {
                var e = this, t = Array.prototype.slice.call(arguments), n = t.shift();
                if (n = "init" == n ? "initPanels" : n, this.cbck[n]) for (var s = 0, i = this.cbck[n].length; s < i; s++) this.cbck[n][s].apply(e, t)
            }, _initMenu: function () {
                ...
                var t = [i.menu];
                this.opts.slidingSubmenus || t.push(i.vertical), this.opts.extensions = this.opts.extensions.length ? "mm-" + this.opts.extensions.join(" mm-") : "", this.opts.extensions && t.push(this.opts.extensions), this.$menu.addClass(t.join(" ")), this.trigger("_initMenu")
            }, _initPanels: function (t) {
                var s = this, o = this.__findAddBack(t, "ul, ol");
                this.__refactorClass(o, this.conf.classNames.inset, "inset").addClass(i.nolistview + " " + i.nopanel), o.not("." + i.nolistview).addClass(i.listview);
                var r = this.__findAddBack(t, "." + i.listview).children();
                ...
                this.__refactorClass(d, this.conf.classNames.vertical, "vertical"), this.opts.slidingSubmenus || d.addClass(i.vertical), d.each(function () {
                    var t = e(this), n = t;
                    t.is("ul, ol") ? (t.wrap('<div class="' + i.panel + '" />'), n = t.parent()) : n.addClass(i.panel);
                    var a = t.attr("id");
                    t.removeAttr("id"), n.attr("id", a || s.__getUniqueId()), t.hasClass(i.vertical) && (t.removeClass(s.conf.classNames.vertical), n.add(n.parent()).addClass(i.vertical)), l = l.add(n)
                });
                var c = e("." + i.panel, this.$menu);
                l.each(function (t) {
                    var o, r, l = e(this), d = l.parent(), c = d.children("a, span").first();
                    if (d.is("." + i.panels) || (d.data(a.child, l), l.data(a.parent, d)), d.children("." + i.next).length || d.parent().is("." + i.listview) && (o = l.attr("id"), r = e('<a class="' + i.next + '" href="#' + o + '" data-target="#' + o + '" />').insertBefore(c), c.is("span") && r.addClass(i.fullsubopen)), !l.children("." + i.navbar).length && !d.hasClass(i.vertical)) {
                        d.parent().is("." + i.listview) ? d = d.closest("." + i.panel) : (c = d.closest("." + i.panel).find('a[href="#' + l.attr("id") + '"]').first(), d = c.closest("." + i.panel));
                        var p = !1, u = e('<div class="' + i.navbar + '" />');
                        if (s.opts.navbar.add && l.addClass(i.hasnavbar), d.length) {
                            switch (o = d.attr("id"), s.opts.navbar.titleLink) {
                                case"anchor":
                                    p = c.attr("href");
                                    break;
                                case"panel":
                            ...
                            u.append('<a class="' + i.btn + " " + i.prev + '" href="#' + o + '" data-target="#' + o + '" />').append(e('<a class="' + i.title + '"' + (p ? ' href="' + p + '"' : "") + " />").text(c.text())).prependTo(l)
                        } else s.opts.navbar.title && u.append('<a class="' + i.title + '">' + e[n].i18n(s.opts.navbar.title) + "</a>").prependTo(l)
                    }
                });
                var p = this.__findAddBack(t, "." + i.listview).children("." + i.selected).removeClass(i.selected).last().addClass(i.selected);
                p.add(p.parentsUntil("." + i.menu, "li")).filter("." + i.vertical).addClass(i.opened).end().each(function () {
                    e(this).parentsUntil("." + i.menu, "." + i.panel).not("." + i.vertical).first().addClass(i.opened).parentsUntil("." + i.menu, "." + i.panel).not("." + i.vertical).first().addClass(i.opened).addClass(i.subopened)
                }), p.children("." + i.panel).not("." + i.vertical).addClass(i.opened).parentsUntil("." + i.menu, "." + i.panel).not("." + i.vertical).first().addClass(i.opened).addClass(i.subopened);
                var u = c.filter("." + i.opened);
                return u.length || (u = l.first()), u.addClass(i.opened).last().addClass(i.current), l.not("." + i.vertical).not(u.last()).addClass(i.hidden).end().filter(function () {
